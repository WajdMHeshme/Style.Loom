  ...
  return (
    <section className="w-full 2xl:px-[162px] md:px-[80px] px-[16px] pt-[200px]">
      <div className="rounded-t-[20px] overflow-hidden border-2 border-dashed border-black15 relative">
        <img src={"/assets/imgs/Testimonials/Abstract Design.png"} alt="" aria-hidden className="hidden md:block pointer-events-none absolute top-0 right-0 translate-x-[10%] -translate-y-[5%] max-w-[18rem] md:max-w-[22rem]" />
        <div className="p-6">
      ...
      <div className="flex flex-wrap border-t-0 rounded-b-[20px] overflow-hidden border-2 border-dashed border-black15">
        {loading ? (
          <div className="w-full flex justify-center items-center p-12"><LoadingWave /></div>
        ) : approved.length === 0 ? (
      ...
      <div className="w-full flex justify-center py-8">
        <button onClick={handleOpenModal} className="px-6 py-3 rounded-full shadow-sm" style={{ background: "var(--color-brown60)", color: "white" }}>Add Review</button>
      </div>
