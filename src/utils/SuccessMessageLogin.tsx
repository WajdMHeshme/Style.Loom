...
const SuccessMessage: React.FC<SuccessMessageProps> = ({
  ...
  const brownDark = "var(--color-brown80, #927a60)";
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            ...
            <div
              ...
              style={{ background: `linear-gradient(135deg, ${brown} 0%, ${brownDark} 100%)` }}
            >
        ...
        <div className="text-center">
          ...
          <div className="flex gap-3">
            <button
              ...
              style={{ background: `linear-gradient(90deg, ${brown} 0%, ${brownDark} 100%)`, color: "#0b0b0b" }}
            >
              Continue
            </button>
          </div>
